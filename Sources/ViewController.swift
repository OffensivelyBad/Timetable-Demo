...
class ViewController: UIViewController, SpreadsheetViewDataSource, SpreadsheetViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        spreadsheetView.register(TestCell.self, forCellWithReuseIdentifier: String(describing: TestCell.self))
...
//            return cell
            let cell = spreadsheetView.dequeueReusableCell(withReuseIdentifier: String(describing: TestCell.self), for: indexPath) as! TestCell
            cell.hasSingles = minutes % 2 == 0 ? true : false
            cell.hasMultis = minutes % 2 == 0 && duration % 2 == 0 ? true : false
            cell.hasBigs = duration % 2 == 0 ? true : false
            return cell
        }
